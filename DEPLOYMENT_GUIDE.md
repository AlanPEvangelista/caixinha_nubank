...
```bash
git clone <url-do-repositorio> caixinha_nubank
cd caixinha_nubank
```
...
Se você tiver um firewall habilitado, permita o tráfego na porta 3000 (porta padrão do servidor):
...
2. Se ocorrerem problemas de permissões:
   - Verifique a propriedade dos arquivos: `ls -la /home/alan/caixinha_nubank`
   - Garanta que o usuário alan possa ler os arquivos: `chmod -R 755 /home/alan/caixinha_nubank`

3. Se o banco de dados não estiver funcionando:
   - Verifique se o diretório `data` existe e tem as permissões corretas
   - O banco de dados SQLite é armazenado em `/home/alan/caixinha_nubank/data/nubank_tracker.db`